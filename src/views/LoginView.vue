<template>
  <div class="min-w-full h-full flex justify-center items-center">
    <div
      class="bg-gray-300 p-4 w-full max-w-sm rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700"
    >
      <form class="space-y-6" action="#">
        ...
        <div class="flex items-start">
          <div class="flex items-start">
            <div class="flx items-center h-5">
              <input
                id="remember"
                type="checkbox"
                value=""
          ...
          <a
            href="#"
            class="ml-auto text-sm text-red-700 hover:underline dark:text-blue-500"
            >Забыли пароль?</a
          >
        </div>
        <button
